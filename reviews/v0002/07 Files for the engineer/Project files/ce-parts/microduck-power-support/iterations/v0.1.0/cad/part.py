...
def build(doc, params=None):
    ...
    for z in RIDGE_Z:
        # Reference-mesh rays cross continuous material from y25 to the
        # rounded ridge top. A full circle alone starts at y26.2, leaving
        # 0.14 mm of air above the y26.06 tongue (five detached solids).
        # Restore each straight root under its unchanged rounded crown.
        root_y = PY0 + TONGUE_T - 0.02
        p.box(2 * TONGUE_HW, RIDGE_Y - root_y, 2 * RIDGE_R,
              at=(-TONGUE_HW, root_y, z - RIDGE_R))
