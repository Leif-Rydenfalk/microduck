...
from cecad.sheets import Sheet, _clip_to_disc, text_boxes
...
def verify_section(svg,record,page_height):
    ...
    return {'verdict':'FAIL' if failures else 'PASS','failures':failures,'source_edge':record['source_edge']}
