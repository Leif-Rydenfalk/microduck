...
The measured readiness refresh found 27 distinct existing drawing reports, all
failing; six expected drawing entries were missing. This is the baseline before
the shin iteration. The shin redraw now dimensions 111/111 measured features
and includes six rendered views, but still fails layout/area rules and is not
released. See its [iteration report](../out/drawings/microduck-shin/iteration-2026-09-08.html).
