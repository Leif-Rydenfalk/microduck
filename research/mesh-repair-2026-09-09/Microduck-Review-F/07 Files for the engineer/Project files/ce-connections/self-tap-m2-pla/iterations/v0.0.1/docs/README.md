...
A M2 ISO 4762 cap screw thread-forming its own thread in an FDM-printed Ø1.60 mm pilot.

## What is measured

- 33 pilot holes of this size on Pollen's reference meshes (`out/fasteners/features-by-mesh.json`), measured by `cecad.meshfeatures.features()`.
- The screw: `part:screw-m2-iso4762`, built parametrically and measured against the ISO 4762 table (`out/fasteners/screw-parts-verify.json`, 120 rows 0 FAIL).
