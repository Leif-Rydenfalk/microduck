...
SRC=OUT.parent/'plates/HEAD-V5/microduck-head-v5.gcode.3mf'
...
axes.flat[-1].axis('off');fig.suptitle('Exact HEAD-V5 archive meshes — independent z-buffer render');fig.tight_layout();fig.savefig(OUT/'exact-meshes.png',dpi=150);plt.close(fig)
