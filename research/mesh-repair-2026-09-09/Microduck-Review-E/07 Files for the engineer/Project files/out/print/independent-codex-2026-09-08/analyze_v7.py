...
OUT=Path(__file__).parent/'v7-validation'
OUT.mkdir(exist_ok=True)
SRC=OUT.parent.parent/'plates/HEAD-V7-candidate/microduck-head-v7.gcode.3mf'
...
axes.flat[-1].axis('off');fig.suptitle('Exact HEAD-V7 archive meshes — independent z-buffer render');fig.tight_layout();fig.savefig(OUT/'exact-meshes.png',dpi=150);plt.close(fig)
