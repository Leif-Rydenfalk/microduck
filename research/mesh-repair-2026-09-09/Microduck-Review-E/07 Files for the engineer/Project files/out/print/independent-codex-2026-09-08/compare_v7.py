...
source=Path(__file__).with_name('analyze_v7.py').read_text()
...
fig.suptitle('HEAD-V7: exact mesh section (orange dashed) versus actual model extrusion (blue), support grey\nShared-vertex candidate; compare repaired eye-ring and bottom-shell layers');fig.tight_layout();fig.savefig(OUT/'mesh-versus-extrusion-v7.png',dpi=180)
