...
**PASS** — p95 surface distance 0.79 mm <= 1.00 both ways; bbox within 0.00 mm
...
| p95 mm | 0.786 | 0.266 |
| max mm | 4.551 | 1.504 |
| within 1.0 mm | 96.2% | 99.6% |

bbox ours [23.0, 25.8, 20.5]  ref [23.0, 25.8, 20.5]  delta [0.0, 0.0, 0.0]
volume ratio ours/ref 0.9495 (closed-mesh figure, see compare.json)
