...
OUT=Path(__file__).parent/'v9-validation'
OUT.mkdir(exist_ok=True)
SRC=OUT.parent.parent/'plates/HEAD-V9-candidate/microduck-head-v9.gcode.3mf'
...
axes.flat[-1].axis('off');fig.suptitle('Exact HEAD-V9 archive meshes — independent z-buffer render');fig.tight_layout();fig.savefig(OUT/'exact-meshes.png',dpi=150);plt.close(fig)
