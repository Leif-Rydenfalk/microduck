...
SECTIONS = [
    ...
    ("Specification & parts", "What the machine is, measured.", [
        ...
        ("FASTENERS.html", "Fasteners \u2014 every screw as a real solid",
         "The fastening system measured rather than assumed: the hole census read off the geometry, every screw run built as a real solid and placed through a connection (never a literal transform), and the per-run physical audit \u2014 head seating, shank clearance, thread engagement, breakout \u2014 with the count that is placed against the count that is implied. Generated by tools/gen_fasteners_doc.py."),
