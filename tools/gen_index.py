...
SECTIONS = [
    ("1:1 recreation · September 8", "Current source corrections, factory inquiries and unresolved original-unit evidence.", [
        ...
        ("research/ming-handoff-2026-09-08/update-b/READ-FIRST.html", "Ming engineering review packet B", "The original packet plus PCBA, power, fastener, bearing and identity findings. Prepared files do not establish delivery."),
